...
#'        \code{nwstats} output from \code{\link{calc_nwstats.mard.m2}}.
...
#'
#' @return
#' A list object of class \code{param.mard.m2}, which can be passed to
#' EpiModel function \code{netsim}.
#'
#' @export
param.mard.m2 <- function(nwstats,
  ...
  class(p) <- c("param.mard.m2", "param.net")
  return(p)
}
...
#'
#' @return
#' A list object of class \code{init.mard.m2}, which can be passed to EpiModel
...
#'
#' @return
#' A list object of class \code{control.mard.m2}, which can be passed to the
#' EpiModel function \code{netsim}.
#'
#' @export
